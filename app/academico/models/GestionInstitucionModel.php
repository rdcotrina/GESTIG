...
* Descripcion : GestionInstitucionModel.php
* ---------------------------------------
*/ 
 
namespace Academico\Models;

class GestionInstitucionModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_aca_institucion_gestion_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_aca_institucion_gestion_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkGestionInstitucion,
    ...
    public function consulta() {
        $query = "CALL sp_aca_institucion_gestion_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
