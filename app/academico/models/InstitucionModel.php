 ...
 * Descripcion : InstitucionModel.php
 * ---------------------------------------
 */

namespace Academico\Models;

class InstitucionModel extends \Vendor\DataBase {
    ...
    public function grid() {
        $query = "CALL sp_aca_institucion_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_aca_institucion_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkInstitucion,
    ...
    public function consulta($flag = '', $tipo_get = 1) {
        ...
        $query = "CALL sp_aca_institucion_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
