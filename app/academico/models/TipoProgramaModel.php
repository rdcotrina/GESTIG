...
* Descripcion : TipoProgramaModel.php
* ---------------------------------------
*/ 
 
namespace Academico\Models;

class TipoProgramaModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_aca_programa_tipo_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_aca_programa_tipo_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkTipoPrograma,
    ...
    public function consulta() {
        $query = "CALL sp_aca_programa_tipo_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
