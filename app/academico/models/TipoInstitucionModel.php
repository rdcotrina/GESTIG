...
* Descripcion : TipoInstitucionModel.php
* ---------------------------------------
*/ 
 
namespace Academico\Models;

class TipoInstitucionModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_aca_institucion_tipo_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_aca_institucion_tipo_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkTipoInstitucion,
    ...
    public function consulta() {
        $query = "CALL sp_aca_institucion_tipo_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
