...
* Descripcion : ModalidadEstudioModel.php
* ---------------------------------------
*/ 
 
namespace Academico\Models;

class ModalidadEstudioModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_aca_modalidad_estudio_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_aca_modalidad_estudio_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkModalidadEstudio,
    ...
    public function consulta() {
        $query = "CALL sp_aca_modalidad_estudio_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
