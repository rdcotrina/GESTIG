...
* Descripcion : TipoInstitucionAjax.js 
* ---------------------------------------
*/ 
"use strict";
class TipoInstitucionAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'academico/TipoInstitucion/';
        this._views = 'app/academico/views/tipoinstitucion/';
        this._idGridTipoInstitucion = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridTipoInstitucion(context._alias);
            }
        });
    }
    
    gridTipoInstitucion(alias){
        $(`#${TABS.ACATINS}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.TipoInstitucionDom.formNewTipoInstitucion`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.TipoInstitucionDom.formEditTipoInstitucion",
                        serverParams: "_1"
                    }
                }, {
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.TipoInstitucionDom.deleteTipoInstitucion",
                        serverParams: "_1"
                    }
                }]
            },
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridTipoInstitucion = oSettings.tObjectTable;
            }
        });
    }
               
    newTipoInstitucion(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editTipoInstitucion(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findTipoInstitucion(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoInstitucion', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoInstitucion', value: obj.context._key});
            }
        });
    }
            
    findTipoInstitucion(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findTipoInstitucion`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setTipoInstitucion(obj.data);
            }
        });
    }
