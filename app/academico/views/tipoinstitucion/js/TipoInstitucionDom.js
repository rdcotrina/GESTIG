...
* Descripcion : TipoInstitucionDom.js
* ---------------------------------------
*/ 
"use strict";

class TipoInstitucionDom_ extends TipoInstitucionAjax_ {
    ...
    formNewTipoInstitucion(btn, tk) {
        super.newTipoInstitucion(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditTipoInstitucion(btn, id, tk) {
        this._key = id;
        super.editTipoInstitucion(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
    ...
    deleteTipoInstitucion(btn, id, tk) {
        this._key = id;
        var d = super.delete;
