...
* Descripcion : TipoProgramaAjax.js 
* ---------------------------------------
*/ 
"use strict";
class TipoProgramaAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'academico/TipoPrograma/';
        this._views = 'app/academico/views/tipoprograma/';
        this._idGridTipoPrograma = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridTipoPrograma(context._alias);
            }
        });
    }
    
    gridTipoPrograma(alias){
        $(`#${TABS.ACATIPR}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.TipoProgramaDom.formNewTipoPrograma`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.TipoProgramaDom.formEditTipoPrograma",
                        serverParams: "_1"
                    }
                }, {
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.TipoProgramaDom.deleteTipoPrograma",
                        serverParams: "_1"
                    }
                }]
            },
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridTipoPrograma = oSettings.tObjectTable;
            }
        });
    }
               
    newTipoPrograma(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editTipoPrograma(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findTipoPrograma(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoPrograma', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoPrograma', value: obj.context._key});
            }
        });
    }
            
    findTipoPrograma(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findTipoPrograma`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setTipoPrograma(obj.data);
            }
        });
    }
