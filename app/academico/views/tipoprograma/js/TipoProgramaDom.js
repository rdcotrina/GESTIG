...
* Descripcion : TipoProgramaDom.js
* ---------------------------------------
*/ 
"use strict";

class TipoProgramaDom_ extends TipoProgramaAjax_ {
    ...
    formNewTipoPrograma(btn, tk) {
        super.newTipoPrograma(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditTipoPrograma(btn, id, tk) {
        this._key = id;
        super.editTipoPrograma(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
