    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title tr-language" data-tr="title_gestioninstitucion_new"></h4>
            </div>
            <div class="modal-body form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="txt_descripcion" name="txt_descripcion" maxlength="150" /> 
                    </div>
                </div> 
                <div class="form-group">
    ...
    <js id="js_formNew">
        $("#formNew").validate({
            ...
            submitHandler: function () {
                Exe.GestionInstitucionDom.postNewGestionInstitucion(__PK__);
            }
        });
    </js>
</form>