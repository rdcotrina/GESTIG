...
* Descripcion : InstitucionDom.js
* ---------------------------------------
*/ 
"use strict";

class InstitucionDom_ extends InstitucionAjax_ {
    ...
    formNewInstitucion(btn, tk) {
        super.newInstitucion(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditInstitucion(btn, id, tk) {
        this._key = id;
        super.editInstitucion(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
