    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title tr-language" data-tr="title_semestre_edit"></h4>
            </div>
            <div class="modal-body form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label tr-language" data-tr="tiposemestre"></label>
                    <div class="col-lg-9" id="div_tiposemestre">
                        <select class="form-control" id="lst_tiposemestre" name="lst_tiposemestre">
                            <option value=""></option>
                        </select> 
                        <i></i>
                    </div>
    ...
    <js id="js_formEdit">
        $("#formEdit").validate({
            ...
            submitHandler: function () {
                    Exe.SemestreDom.postEditSemestre(__PK__);
            }
        });
    </js>
</form> 