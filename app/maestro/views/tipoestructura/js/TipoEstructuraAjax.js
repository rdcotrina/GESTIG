...
* Descripcion : TipoEstructuraAjax.js 
* ---------------------------------------
*/ 
"use strict";
class TipoEstructuraAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/TipoEstructura/';
        this._views = 'app/maestro/views/tipoestructura/';
        this._idGridTipoEstructura = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridTipoEstructura(context._alias);
            }
        });
    }
    
    gridTipoEstructura(alias){
        $(`#${TABS.MAETIEST}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.TipoEstructuraDom.formNewTipoEstructura`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.TipoEstructuraDom.formEditTipoEstructura",
                    ...
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.TipoEstructuraDom.deleteTipoEstructura",
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridTipoEstructura = oSettings.tObjectTable;
            }
        });
    }
               
    newTipoEstructura(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editTipoEstructura(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findTipoEstructura(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoEstructura', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoEstructura', value: obj.context._key});
            }
        });
    }
            
    findTipoEstructura(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findTipoEstructura`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setTipoEstructura(obj.data);
            }
        });
    }
