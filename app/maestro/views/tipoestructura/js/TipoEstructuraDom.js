...
* Descripcion : TipoEstructuraDom.js
* ---------------------------------------
*/ 
"use strict";

class TipoEstructuraDom_ extends TipoEstructuraAjax_ {
    ...
    formNewTipoEstructura(btn, tk) {
        super.newTipoEstructura(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditTipoEstructura(btn, id, tk) {
        this._key = id;
        super.editTipoEstructura(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
    ...
    deleteTipoEstructura(btn, id, tk) {
        this._key = id;
        var d = super.delete;
