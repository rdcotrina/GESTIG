...
* Descripcion : EstadoCivilAjax.js 
* ---------------------------------------
*/ 
"use strict";
class EstadoCivilAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/EstadoCivil/';
        this._views = 'app/maestro/views/estadocivil/';
        this._idGridEstadoCivil = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridEstadoCivil(context._alias);
            }
        });
    }
    
    gridEstadoCivil(alias){
        $(`#${TABS.MAEESTCV}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.EstadoCivilDom.formNewEstadoCivil`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.EstadoCivilDom.formEditEstadoCivil",
                    ...
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.EstadoCivilDom.deleteEstadoCivil",
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridEstadoCivil = oSettings.tObjectTable;
            }
        });
    }
               
    newEstadoCivil(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editEstadoCivil(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findEstadoCivil(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkEstadoCivil', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkEstadoCivil', value: obj.context._key});
            }
        });
    }
            
    findEstadoCivil(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findEstadoCivil`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setEstadoCivil(obj.data);
            }
        });
    }
