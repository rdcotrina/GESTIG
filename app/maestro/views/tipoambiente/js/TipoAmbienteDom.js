...
* Descripcion : TipoAmbienteDom.js
* ---------------------------------------
*/ 
"use strict";

class TipoAmbienteDom_ extends TipoAmbienteAjax_ {
    ...
    formNewTipoAmbiente(btn, tk) {
        super.newTipoAmbiente(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditTipoAmbiente(btn, id, tk) {
        this._key = id;
        super.editTipoAmbiente(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
