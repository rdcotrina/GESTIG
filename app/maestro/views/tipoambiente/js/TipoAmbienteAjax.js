...
* Descripcion : TipoAmbienteAjax.js 
* ---------------------------------------
*/ 
"use strict";
class TipoAmbienteAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/TipoAmbiente/';
        this._views = 'app/maestro/views/tipoambiente/';
        this._idGridTipoAmbiente = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridTipoAmbiente(context._alias);
            }
        });
    }
    
    gridTipoAmbiente(alias){
        $(`#${TABS.MAETIAMB}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.TipoAmbienteDom.formNewTipoAmbiente`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.TipoAmbienteDom.formEditTipoAmbiente",
                    ...
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.TipoAmbienteDom.deleteTipoAmbiente",
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridTipoAmbiente = oSettings.tObjectTable;
            }
        });
    }
               
    newTipoAmbiente(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editTipoAmbiente(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findTipoAmbiente(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoAmbiente', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoAmbiente', value: obj.context._key});
            }
        });
    }
            
    findTipoAmbiente(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findTipoAmbiente`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setTipoAmbiente(obj.data);
            }
        });
    }
