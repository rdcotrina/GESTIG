...
* Descripcion : TipoDocumentoDom.js
* ---------------------------------------
*/ 
"use strict";

class TipoDocumentoDom_ extends TipoDocumentoAjax_ {
    ...
    formNewTipoDocumento(btn, tk) {
        super.newTipoDocumento(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditTipoDocumento(btn, id, tk) {
        this._key = id;
        super.editTipoDocumento(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
