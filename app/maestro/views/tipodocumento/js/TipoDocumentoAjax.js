...
* Descripcion : TipoDocumentoAjax.js 
* ---------------------------------------
*/ 
"use strict";
class TipoDocumentoAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/TipoDocumento/';
        this._views = 'app/maestro/views/tipodocumento/';
        this._idGridTipoDocumento = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridTipoDocumento(context._alias);
            }
        });
    }
    
    gridTipoDocumento(alias){
        $(`#${TABS.MAETIDOC}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.TipoDocumentoDom.formNewTipoDocumento`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.TipoDocumentoDom.formEditTipoDocumento",
                        serverParams: "_1"
                    }
                }, {
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.TipoDocumentoDom.deleteTipoDocumento",
                        serverParams: "_1"
                    }
                }]
            },
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridTipoDocumento = oSettings.tObjectTable;
            }
        });
    }
               
    newTipoDocumento(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editTipoDocumento(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findTipoDocumento(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoDocumento', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoDocumento', value: obj.context._key});
            }
        });
    }
            
    findTipoDocumento(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findTipoDocumento`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setTipoDocumento(obj.data);
            }
        });
    }
