...
* Descripcion : EstructuraDom.js
* ---------------------------------------
*/ 
"use strict";

class EstructuraDom_ extends EstructuraAjax_ {
    ...
    formNewEstructura(btn, tk) {
        super.newEstructura(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditEstructura(btn, id, tk) {
        this._key = id;
        super.editEstructura(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
