...
* Descripcion : EstructuraAjax.js 
* ---------------------------------------
*/ 
"use strict";
class EstructuraAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/Estructura/';
        this._views = 'app/maestro/views/estructura/';
        this._idGridEstructura = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridEstructura(context._alias);
            }
        });
    }
    
    gridEstructura(alias){
        $(`#${TABS.MAEEST}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.EstructuraDom.formNewEstructura`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.EstructuraDom.formEditEstructura",
                    ...
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.EstructuraDom.deleteEstructura",
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridEstructura = oSettings.tObjectTable;
            }
        });
    }
               
    newEstructura(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editEstructura(btn, context, tk) {
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findEstructura(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkEstructura', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkEstructura', value: obj.context._key});
            }
        });
    }
            
    findEstructura(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findEstructura`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setEstructura(obj.data);
            }
        });
    }
