...
* Descripcion : TipoSemestreDom.js
* ---------------------------------------
*/ 
"use strict";

class TipoSemestreDom_ extends TipoSemestreAjax_ {
    ...
    formNewTipoSemestre(btn, tk) {
        super.newTipoSemestre(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditTipoSemestre(btn, id, tk) {
        this._key = id;
        super.editTipoSemestre(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
