...
* Descripcion : TipoSemestreAjax.js 
* ---------------------------------------
*/ 
"use strict";
class TipoSemestreAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/TipoSemestre/';
        this._views = 'app/maestro/views/tiposemestre/';
        this._idGridTipoSemestre = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridTipoSemestre(context._alias);
            }
        });
    }
    
    gridTipoSemestre(alias){
        $(`#${TABS.MAETISEM}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.TipoSemestreDom.formNewTipoSemestre`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.TipoSemestreDom.formEditTipoSemestre",
                    ...
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.TipoSemestreDom.deleteTipoSemestre",
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridTipoSemestre = oSettings.tObjectTable;
            }
        });
    }
               
    newTipoSemestre(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editTipoSemestre(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findTipoSemestre(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoSemestre', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkTipoSemestre', value: obj.context._key});
            }
        });
    }
            
    findTipoSemestre(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findTipoSemestre`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setTipoSemestre(obj.data);
            }
        });
    }
