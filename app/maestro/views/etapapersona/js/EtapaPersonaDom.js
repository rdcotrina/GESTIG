...
* Descripcion : EtapaPersonaDom.js
* ---------------------------------------
*/ 
"use strict";

class EtapaPersonaDom_ extends EtapaPersonaAjax_ {
    ...
    formNewEtapaPersona(btn, tk) {
        super.newEtapaPersona(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditEtapaPersona(btn, id, tk) {
        this._key = id;
        super.editEtapaPersona(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
