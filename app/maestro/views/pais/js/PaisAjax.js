...
* Descripcion : PaisAjax.js 
* ---------------------------------------
*/ 
"use strict";
class PaisAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/Pais/';
        this._views = 'app/maestro/views/pais/';
        this._idGridPais = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridPais(context._alias);
            }
        });
    }
    
    gridPais(alias){
        $(`#${TABS.MAEPAIS}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridPais = oSettings.tObjectTable;
            }
        });
    }
               
    newPais(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkPais', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkPais', value: obj.context._key});
            }
        });
    }
    ...
    findPais(contextDom) {
        super.send({
            ...
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findPais`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setPais(obj.data);
            }
        });
    }
