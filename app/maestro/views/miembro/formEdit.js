    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title tr-language" data-tr="title_miembro_edit"></h4>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 smart-form">  
                        <div class="inline-group">
                            <label class="radio">
                                <input value="H" checked="" id="rd_sexoH" name="rd_sexo" type="radio"><i></i> <span style="margin-top: -6px;display: block" class="tr-language" data-tr="hombre"></span>
                            </label>
                            <label class="radio">
                                <input value="M" id="rd_sexoM" name="rd_sexo" type="radio"><i></i> <span style="margin-top: -6px;display: block" class="tr-language" data-tr="mujer"></span>
                            </label>
                        </div>   
                    </div>
                </div>
    ...
    <js id="js_formEdit">
        $("#formEdit").validate({
            ...
            submitHandler: function () {
                    Exe.MiembroDom.postEditMiembro(__PK__);
            }
        });
    </js>
</form> 