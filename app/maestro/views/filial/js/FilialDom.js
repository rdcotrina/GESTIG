...
* Descripcion : FilialDom.js
* ---------------------------------------
*/ 
"use strict";

class FilialDom_ extends FilialAjax_ {
    ...
    formNewFilial(btn, tk) {
        super.newFilial(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditFilial(btn, id, tk) {
        this._key = id;
        super.editFilial(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
    ...
    postNewFilial(tk) {
        super.postNew(tk).done(function (obj) {
            ...
            if (obj.ok_error != 'error') {
                ...
                Tools.refreshGrid(this._idGridFilial);
            }
        });
    }
