...
* Descripcion : AmbienteAjax.js 
* ---------------------------------------
*/ 
"use strict";
class AmbienteAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'maestro/Ambiente/';
        this._views = 'app/maestro/views/ambiente/';
        this._idGridAmbiente = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridAmbiente(context._alias);
            }
        });
    }
    
    gridAmbiente(alias){
        $(`#${TABS.MAEAMB}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.AmbienteDom.formNewAmbiente`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.AmbienteDom.formEditAmbiente",
                    ...
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.AmbienteDom.deleteAmbiente",
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridAmbiente = oSettings.tObjectTable;
            }
        });
    }
               
    newAmbiente(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editAmbiente(btn, context, tk) {
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findAmbiente(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkAmbiente', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkAmbiente', value: obj.context._key});
            }
        });
    }
            
    findAmbiente(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findAmbiente`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setAmbiente(obj.data);
            }
        });
    }
