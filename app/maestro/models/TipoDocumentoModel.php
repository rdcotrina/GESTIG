...
* Descripcion : TipoDocumentoModel.php
* ---------------------------------------
*/ 
 
namespace Maestro\Models;

class TipoDocumentoModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_documento_tipo_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_documento_tipo_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkTipoDocumento,
    ...
    public function consulta() {
        $query = "CALL sp_app_documento_tipo_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
