...
class PaisModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_pais_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_pais_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkPais,
    ...
    public function consulta() {
        $query = "CALL sp_app_pais_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
