...
* Descripcion : FilialModel.php
* ---------------------------------------
*/ 
 
namespace Maestro\Models;

class FilialModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_filial_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_filial_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkFilial,
    ...
    public function consulta() {
        $query = "CALL sp_app_filial_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
