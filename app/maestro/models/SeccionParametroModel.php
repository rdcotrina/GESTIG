...
* Descripcion : SeccionParametroModel.php
* ---------------------------------------
*/ 
 
namespace Maestro\Models;

class SeccionParametroModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_parametro_seccion_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_parametro_seccion_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkSeccionParametro,
    ...
    public function consulta() {
        $query = "CALL sp_app_parametro_seccion_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
