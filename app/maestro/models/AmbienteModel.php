...
* Descripcion : AmbienteModel.php
* ---------------------------------------
*/ 
 
namespace Maestro\Models;

class AmbienteModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_ambiente_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_ambiente_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkAmbiente,
    ...
    public function consulta() {
        $query = "CALL sp_app_ambiente_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
