...
* Descripcion : EstadoCivilModel.php
* ---------------------------------------
*/ 
 
namespace Maestro\Models;

class EstadoCivilModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_estado_civil_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_estado_civil_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkEstadoCivil,
    ...
    public function consulta() {
        $query = "CALL sp_app_estado_civil_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
