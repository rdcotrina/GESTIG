...
* Descripcion : EtapaPersonaModel.php
* ---------------------------------------
*/ 
 
namespace Maestro\Models;

class EtapaPersonaModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_ig_etapa_persona_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_ig_etapa_persona_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkEtapaPersona,
    ...
    public function consulta() {
        $query = "CALL sp_ig_etapa_persona_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
