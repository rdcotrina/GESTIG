 ...
 * Descripcion : EstructuraModel.php
 * ---------------------------------------
 */

namespace Maestro\Models;

class EstructuraModel extends \Vendor\DataBase {
    ...
    public function grid() {
        $query = "CALL sp_app_estructura_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_estructura_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkEstructura,
    ...
    public function consulta() {
        $query = "CALL sp_app_estructura_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
    ...
    public function consulta2($flag = '', $tipo_get = 1) {
        if (!empty($flag)) {
