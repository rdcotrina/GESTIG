...
* Descripcion : SemestreModel.php
* ---------------------------------------
*/ 
 
namespace Maestro\Models;

class SemestreModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_semestre_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_semestre_mantenimiento (:flag,:key,:nombre,:tiposemestre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkSemestre,
            ':nombre' => @$this->_form->txt_descripcion,
            ':tiposemestre' => @$this->_form->lst_tiposemestre,
    ...
    public function consulta() {
        $query = "CALL sp_app_semestre_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
