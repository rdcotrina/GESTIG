...
* Descripcion : FilialController.php
* ---------------------------------------
*/ 
...
use \Maestro\Filters\FilialFilter;

class FilialController extends \Maestro\Models\FilialModel {

    use Controller {
        Controller::__construct as private __cConstruct;
    }
    use FilialFilter {
        FilialFilter::__construct as private __fConstruct;
    }
