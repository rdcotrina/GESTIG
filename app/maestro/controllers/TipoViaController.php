...
* Descripcion : TipoViaController.php
* ---------------------------------------
*/ 
...
use \Maestro\Filters\TipoViaFilter;

class TipoViaController extends \Maestro\Models\TipoViaModel {

    use Controller {
        Controller::__construct as private __cConstruct;
    }
    use TipoViaFilter {
        TipoViaFilter::__construct as private __fConstruct;
    }
