...
* Descripcion : ModalidadAdmisionAjax.js 
* ---------------------------------------
*/ 
"use strict";
class ModalidadAdmisionAjax_ extends Ajax_ {

    constructor() {
        super();
        this._controller = 'admision/ModalidadAdmision/';
        this._views = 'app/admision/views/modalidadadmision/';
        this._idGridModalidadAdmision = null;
    }
    ...
    formIndex(context){
        return super.send({
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                obj.context.gridModalidadAdmision(context._alias);
            }
        });
    }
    
    gridModalidadAdmision(alias){
        $(`#${TABS.ADMMOD}grid`).livianGrid({
            context: this,
            alias: alias,
            tScrollY: "200px",
            pDisplayLength: 25,
            ...
            tButtons:[{
                button: BTNSYS.NEW,                
                ajax: `Exe.ModalidadAdmisionDom.formNewModalidadAdmision`
            }],             
            ...
            sAxions: {
                buttons: [{
                    button: BTNSYS.EDT,
                    ajax: {
                        fn: "Exe.ModalidadAdmisionDom.formEditModalidadAdmision",
                    ...
                    button: BTNSYS.DEL,
                    ajax: {
                        fn: "Exe.ModalidadAdmisionDom.deleteModalidadAdmision",
            ...
            fnCallback: function (oSettings) {
                oSettings.context._idGridModalidadAdmision = oSettings.tObjectTable;
            }
        });
    }
               
    newModalidadAdmision(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
    ...
    editModalidadAdmision(btn, context, tk) {
        return super.send({
            token: tk,
            element: btn,
            context: this,
            ...
            final: function (obj) {/*se ejecuta una vez que se cargo el HTML en success*/
                ...
                obj.context.findModalidadAdmision(context);
            }
        });
    }
    ...
    postEdit(tk, contextDom) {
        return super.send({
            ...
            serverParams: function (sData, obj) {
                sData.push({name: '_pkModalidadAdmision', value: contextDom._key});
            }
        });
    }
    ...
    delete(btn, tk) {
        return super.send({
            ...
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_pkModalidadAdmision', value: obj.context._key});
            }
        });
    }
            
    findModalidadAdmision(contextDom) {
        super.send({
            flag: 1,
            token: _tk_,
            dataAlias: this._alias,
            context: this,
            root: `${this._controller}findModalidadAdmision`,
            dataType: 'json',
            serverParams: function (sData, obj) {
                sData.push({name: '_criterio', value: contextDom._key});
            },
            success: function (obj) {
                contextDom.setModalidadAdmision(obj.data);
            }
        });
    }
