...
* fecha:        11-08-2017 10:08:21 
* Descripcion : GrupoDom.js
* ---------------------------------------
*/ 
"use strict";

class GrupoDom_ extends GrupoAjax_ {
    ...
    formNewGrupo(btn, tk) {
        super.newGrupo(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditGrupo(btn, id, tk) {
        this._key = id;
        super.editGrupo(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
    ...
    postNewGrupo(tk) {
        super.postNew(tk).done(function (obj) {
            ...
            if (obj.ok_error != 'error') {
                ...
                Tools.refreshGrid(this._idGridGrupo);
            }
        });
    }
