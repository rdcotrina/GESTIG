...
* Descripcion : FaseDom.js
* ---------------------------------------
*/ 
"use strict";

class FaseDom_ extends FaseAjax_ {
    ...
    formNewFase(btn, tk) {
        super.newFase(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditFase(btn, id, tk) {
        this._key = id;
        super.editFase(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
    ...
    postNewFase(tk) {
        super.postNew(tk).done(function (obj) {
            ...
            if (obj.ok_error != 'error') {
                ...
                Tools.refreshGrid(this._idGridFase);
            }
        });
    }
