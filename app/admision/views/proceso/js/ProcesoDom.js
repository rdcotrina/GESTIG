...
* Descripcion : ProcesoDom.js
* ---------------------------------------
*/ 
"use strict";

class ProcesoDom_ extends ProcesoAjax_ {
    ...
    formNewProceso(btn, tk) {
        super.newProceso(btn, this, tk).done(function () {
            $('#formNew').modal('show');
        });
    }
    
    formEditProceso(btn, id, tk) {
        this._key = id;
        super.editProceso(btn, this, tk).done(function () {
            $('#formEdit').modal('show');
        });
    } 
    ...
    postNewProceso(tk) {
        super.postNew(tk).done(function (obj) {
            ...
            if (obj.ok_error != 'error') {
                ...
                Tools.refreshGrid(this._idGridProceso);
            }
        });
    }
