...
use \Admision\Filters\ModalidadAdmisionFilter;

class ModalidadAdmisionController extends \Admision\Models\ModalidadAdmisionModel {
    ...
    public function findModalidadAdmision() {
        echo json_encode($this->consulta());
    }   
    

    public function getModalidadAdmision() {
