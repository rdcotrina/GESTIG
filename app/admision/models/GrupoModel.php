...
* Descripcion : GrupoModel.php
* ---------------------------------------
*/ 
 
namespace Admision\Models;

class GrupoModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_adm_grupo_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_adm_grupo_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkGrupo,
    ...
    public function consulta() {
        $query = "CALL sp_adm_grupo_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
