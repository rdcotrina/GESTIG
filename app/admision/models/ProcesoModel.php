...
* Descripcion : ProcesoModel.php
* ---------------------------------------
*/ 
 
namespace Admision\Models;

class ProcesoModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_adm_proceso_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_adm_proceso_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkProceso,
    ...
    public function consulta() {
        $query = "CALL sp_adm_proceso_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
