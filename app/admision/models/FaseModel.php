...
class FaseModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_adm_fase_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_adm_fase_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkFase,
    ...
    public function consulta($flag = '', $tipo_get = 1) {
        ...
        $query = "CALL sp_adm_fase_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
