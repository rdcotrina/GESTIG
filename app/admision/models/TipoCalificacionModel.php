...
* Descripcion : TipoCalificacionModel.php
* ---------------------------------------
*/ 
 
namespace Admision\Models;

class TipoCalificacionModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_adm_calificacion_tipo_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function consulta() {
        $query = "CALL sp_adm_calificacion_tipo_consultar (:flag,:criterio); ";
        $parms = [
