...
class ModalidadAdmisionModel extends \Vendor\DataBase {
    ...
    public function grid() {
        $query = "CALL sp_adm_modalidad_admision_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_adm_modalidad_admision_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkModalidadAdmision,
    ...
    public function consulta($flag = '', $tipo_get = 1) {
        ...
        $query = "CALL sp_adm_modalidad_admision_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
