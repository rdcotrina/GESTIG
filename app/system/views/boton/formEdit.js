    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title tr-language" data-tr="title_boton_edit"></h4>
            </div>
            <div class="modal-body form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control tr-language-title" id="txt_alias" name="txt_alias" data-trtitle="t_btn_alias" maxlength="10" data-toggle="tooltip" data-placement="right"/> 
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control tr-language-title" id="txt_css" name="txt_css" data-trtitle="t_btn_css" data-toggle="tooltip" data-placement="right"/> 
                    </div>
                </div>
    ...
    <js id="js_formEdit">
        $("#formEdit").validate({
            ...
            submitHandler: function () {
                    Exe.BotonDom.postEditBoton(__PK__);
            }
        });
    </js>
</form>
