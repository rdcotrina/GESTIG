...
class BotonModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_adm_boton_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento(){
        $query = "CALL sp_adm_boton_mantenimiento (:flag,:key,:nboton,:alias,:icono,:css,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkKey,
    ...
    public function consulta(){
        $query = "CALL sp_adm_boton_consulta (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
