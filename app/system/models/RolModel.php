...
class RolModel extends \Vendor\DataBase {
    ...
    public function grid(){
        $query = "CALL sp_app_rol_grid (:iDisplayStart,:iDisplayLength,:pOrder,:pFilterCols,:sExport);";
        $parms = [
    ...
    public function mantenimiento() {
        $query = "CALL sp_app_rol_mantenimiento (:flag,:key,:nombre,:activo,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkRol,
    ...
    public function mantenimientoOpcion() {
        $query = "CALL sp_app_rol_mantenimiento_opcion (:flag,:key,:keyOpcion,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':key' => @$this->_form->_pkRol,
            ':keyOpcion' => @$this->_form->_pkOpcion,
            ':usuario' => $this->_usurio,
            ':ipPublica' => $this->_ipPublica,
            ':ipLocal' => $this->_ipLocal,
            ':navegador' => $this->_navegador,
    ...
    public function mantenimientoOpcionRol() {
        $query = "CALL sp_app_rol_mantenimiento_opcion_boton (:flag,:keyOpcionRol,:keyBoton,:usuario,:ipPublica,:ipLocal,:navegador,:hostname); ";
        $parms = [
            ':flag' => $this->_form->_flag,
            ':keyOpcionRol' => @$this->_form->_pkRolOpcion,
            ':keyBoton' => @$this->_form->_pkBoton,
            ':usuario' => $this->_usurio,
            ':ipPublica' => $this->_ipPublica,
            ':ipLocal' => $this->_ipLocal,
            ':navegador' => $this->_navegador,
    ...
    public function consulta($flag = '', $tipo_get = 1) {
        ...
        $query = "CALL sp_app_rol_consultar (:flag,:criterio); ";
        $parms = [
            ':flag' => $this->_form->_flag,
